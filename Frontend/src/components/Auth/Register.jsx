    ...
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-100 via-white to-purple-100">
      <div className="flex w-full max-w-4xl bg-white rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="hidden md:flex flex-col justify-center items-center bg-gradient-to-br from-blue-100 to-purple-100 p-8 w-1/2">
          <img src={LoginImage} alt="Register Visual" className="w-64 h-64 object-contain rounded-xl" />
        </div>
        {/* Right Form */}
        <div className="flex-1 flex flex-col justify-center p-8">
          <div className="bg-gradient-to-br from-white to-blue-50 p-6 rounded-lg shadow-2xl w-full max-w-sm border-2 border-blue-100 animate-fade-in-up mx-auto">
