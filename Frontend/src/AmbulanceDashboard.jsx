  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-blue-50">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-lg text-center">
        <h2 className="text-3xl font-bold mb-4 text-blue-800">Ambulance Driver Dashboard</h2>
        <p className="text-lg mb-2">Register a new ambulance driver:</p>
        <form onSubmit={handleSubmit} className="space-y-3 text-left">
          ...
          <input name="hospitalID" value={form.hospitalID} onChange={handleChange} placeholder="Hospital ID" type="number" required className="w-full px-3 py-2 border rounded" />
          <button type="submit" disabled={loading} className="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 disabled:opacity-50">{loading ? 'Registering...' : 'Register'}</button>
        </form>
